...
Como funciona?
- Pressupondo que você já tenha o RabbitMq instalado na sua máquina local. Caso não tenha sugiro acessar o site oficial e realizar o tutorial de instalação. `[text](https://www.rabbitmq.com/download.html)`
